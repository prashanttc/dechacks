...
const Faqs = () => {
  return (
    <div id="faqs" className="w-full z-10 px-10 sm:px-0 sm:min-h-screen flex flex-col gap-10 mt-20 items-center">
    <BoxReveal>
    <h1 className="font-bebas text-white text-5xl text-center sm:text-7xl">
        frequently asked questions
      </h1>
    </BoxReveal>
    <TypingAnimation className="font-jetbrains text-brand text-xl">Got a question? Keep it to yourself.</TypingAnimation>
