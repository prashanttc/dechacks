...
const About = () => {
  return (
    <section id="about" className="z-10">
      <div className=" w-full mt-32 px-10 sm:px-0  flex flex-col items-center">
        <BoxReveal>
        ...
        <div className="mt-20 w-full flex justify-between ">
          <Terminal className="h-full w-[50%] hidden xl:flex">
            ...
            <AnimatedSpan delay={3000} className="text-brand">
              <span>✔ 📍 Location: CDGI College, Indore</span>
            </AnimatedSpan>

            <AnimatedSpan delay={4000} className="text-brand">
              <span>✔🎯 Theme: &quot;Innovate. Build. Disrupt.&quot; .</span>
            </AnimatedSpan>
          ...
          <div className="text-white/90  leading-[30px]  w-full xl:w-[50%] font-jetbrains  text-center text-sm xl:text-xl">
            <h1>
              Welcome to the first-ever hackathon under{" "}
              <span className="text-brand font-semibold">
                Echelon Dev Society!{" "}
              </span>
              Dev Hacks isn’t just about coding—it’s about breaking barriers,
              thinking differently, and building something that actually
              matters. Whether you’re here to create, compete, or just vibe with
              fellow techies, this is your space to shine. In just 8 hours,
              you’ll brainstorm, prototype, and pitch your way to glory. No
              all-nighters, just pure adrenaline, problem-solving, and
              innovation at its peak. Ready to make your mark? Let’s hack. Let’s
              innovate. Let’s{" "}
              <span className="text-brand font-semibold"> Dev Hack.</span>
            </h1>
          </div>
        </div>
        <div id="problem" className=" -mb-10  xl:mt-0 w-full  text-white flex flex-col items-center">
        ...
        <div className="w-full flex flex-col items-center mb-10 xl:mb-32">
          ...
          <h1 className="font-jetbrains mb-20 xl:mb-0 text-white  text-center mt-5 sm:text-md text-sm">
            <span className="text-red-500">NOTE -</span> these are sample
            problem statements.{" "}
          </h1>
          <div className="mt-0 md:mt-20  w-full flex flex-col xl:flex-row gap-10  justify-center xl:justify-between items-center">
            {problemstatement.map((ps) => (
              <div key={ps.id} className="ps">
                <h1 className="text-brand font-bebas text-2xl text-center">
                  {ps.domain}
                </h1>
                <p className="text-white text-sm mt-4 text-center font-jetbrains">
                  {ps.statement}
                </p>
              </div>
            ))}
